...
export default function Feedback() {
  ...
  return (
    <div className="py-16 bg-gradient-to-b from-blue-200 to-purple-100 min-h-screen">
      <div className="container px-8 max-w-xl mx-auto">
        <div className="bg-gradient-to-r from-purple-50 via-blue-50 to-purplen-50 backdrop-blur-md p-8 rounded-2xl shadow-xl border border-white/50
